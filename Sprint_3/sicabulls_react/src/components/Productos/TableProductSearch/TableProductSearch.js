...
import { COLUMNS } from './ColumnsProduct.js'
import './TableProductSearch.css'


const TableProductSearch = () => {
    ...
    return (
        <div>
            <div className="shadow p-3 mb-5 bg-white rounded">
                <table {...getTableProps()} id="table_Products_search" className="table">
                    <thead>
...
export default TableProductSearch